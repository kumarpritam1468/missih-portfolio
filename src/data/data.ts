...
export const projects: ProjectObj[] = [
    {
        ...
        largeDesc: [
            "Two-wheel drive robot controlled by an ATMega324PA microcontroller, programmed in C and C++ with a custom Makefile. Project conducted in a team of six during Fall 2024. The project involved building and programming a robot capable of solving two challenges: finding the shortest path to a chosen point (using Dijkstra's algorithm) and navigating obstacles on a table with specific dimensions and markings.",
    ...
    },
    {
        ...
        largeDesc: [
            "Created a comprehensive web application to evaluate stock investments based on the CAN SLIM strategy, focusing on implementing a custom algorithm to calculate the CAN SLIM index. This algorithm processes multiple financial metrics, including EPS growth, ROE, sales trends, and institutional ownership, derived from real-time data fetched via the unofficial Yahoo Finance API.",
    ...
    },
    {
        ...
        largeDesc: [
            "More Details here Lorem ipsum dolor sit amet consectetur adipisicing elit. Quos, quod."
        ],
        date: "Now",
        inProgress: true
    },
