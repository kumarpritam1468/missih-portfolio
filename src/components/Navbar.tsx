...
const Navbar = () => {
  ...
  return (
    <nav className="">
      ...
      <div className={`flex fixed flex-col justify-center items-center top-0 z-40 border-l border-l-green-600 h-screen bg-black w-[300px] 2xl:w-[400px] max-md:w-screen gap-12 text-3xl ${menuOpen ? 'right-0' : '-right-96 max-md:-right-full'} transition-all duration-500 ease-in-out`}>
